...
class TestCourierCreation:
    ...
    @allure.description("Проверка, что при попытке создать курьера с уже существующим логином возвращается ошибка 409")
    @allure.severity(allure.severity_level.CRITICAL)
    ...
    @allure.description("Проверка корректного тела ответа при успешной регистрации")
    @allure.severity(allure.severity_level.NORMAL)
